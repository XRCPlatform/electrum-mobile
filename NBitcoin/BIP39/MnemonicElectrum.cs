...
namespace NBitcoin
{
    ...
    /// </summary>
    public class MnemonicElectrum
    {
        public MnemonicElectrum(string mnemonic, Wordlist wordlist = null)
        {
            if(mnemonic == null)
        ...
        public MnemonicElectrum(Wordlist wordList, byte[] entropy = null)
        {
        ...
        public MnemonicElectrum(Wordlist wordList, WordCount wordCount)
        ...
        public byte[] DeriveSeed(string passphrase = null)
        {
            ...
            var salt = Concat(Encoding.UTF8.GetBytes("electrum"), Normalize(passphrase));
            ...
            var bytesx = Pbkdf2.ComputeDerivedKey(mac, salt, 2048, 64);
